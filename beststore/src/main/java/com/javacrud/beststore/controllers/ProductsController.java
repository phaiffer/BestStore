package com.javacrud.beststore.controllers;
...
import com.javacrud.beststore.models.ProductDto;
import com.javacrud.beststore.services.ProductsRepository;
...
public class ProductsController {
    ...
    public String createProduct(@Valid @ModelAttribute ProductDto productDto, BindingResult result){
        if (productDto.getImageFile().isEmpty()){
            result.addError(new FieldError("productDto", "imageFile", "The image file is invalid"));
        }
        if(result.hasErrors()){
            return "products/CreateProduct";
        }

        MultipartFile img = productDto.getImageFile();
